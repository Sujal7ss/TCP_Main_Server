...
class Mentor(models.Model):
    ...
    gfgID = models.URLField(max_length=300,null=True,blank=True)
    hackerrankID = models.URLField(max_length=300,null=True,blank=True)
    linkedinID = models.URLField(max_length=300,null=True,blank=True)
